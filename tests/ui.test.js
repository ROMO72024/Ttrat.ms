...
assert(!nodes.app.innerHTML.includes('default-reminder'));assert(nodes.app.innerHTML.includes('1.1.1'));assert(nodes.app.innerHTML.includes('تنبيه تلقائي عند بدء الجلسة'));
